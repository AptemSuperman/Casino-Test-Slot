...
def run():
 ...
 with sync_playwright() as p:
  ...
  ctx=browser.new_context(viewport={'width':960,'height':720});page=ctx.new_page();page.clock.install(time=datetime.datetime(2026,9,20));page.set_content((ROOT/'dist/index.html').read_text());page.clock.pause_at(datetime.datetime(2026,9,20,0,0,3));a=Player(page,ctx,'desktop');a.frame()
